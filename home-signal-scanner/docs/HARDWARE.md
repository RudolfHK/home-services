...
> check Pimoroni, Adafruit, or BerryBase, since they get separate allocation.
...
so connecting three power-hungry SDR devices directly will trigger low-current warnings
